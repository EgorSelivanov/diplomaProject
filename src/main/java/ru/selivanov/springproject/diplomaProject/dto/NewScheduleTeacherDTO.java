...
public class NewScheduleTeacherDTO {
    ...
    public NewScheduleTeacherDTO(String audience, String building, String dayOfWeek, Date startTime, Date endTime, int subjectId, String type, List<Integer> groupId) {
